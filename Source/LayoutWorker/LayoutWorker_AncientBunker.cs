...
public class LayoutWorker_AncientBunker(LayoutDef def) : LayoutWorker_Labyrinth(def)
{
    internal static readonly ThingDef WallDef;
    internal static readonly ThingDef DoorDef;
    internal static readonly TerrainDef FloorTerrain;

    internal static readonly ThingDef WallStuff;
    internal static readonly ThingDef DoorStuff;

    static LayoutWorker_AncientBunker()
    {
